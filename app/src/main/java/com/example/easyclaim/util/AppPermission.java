...
import com.example.easyclaim.Connection_to_the_device_BLE;
    ...
    private void handlePermissionResult(int requestCode, String permission, int grantResult) {
        if (grantResult == PackageManager.PERMISSION_GRANTED) {
            ...
            if (requestCode == REQUEST_BT_PERMISSION) {
                ((Connection_to_the_device_BLE)mActivity).startBleScan(); // Start BLE scan after permission is granted
            }
        } else {
